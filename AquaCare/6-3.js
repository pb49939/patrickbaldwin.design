...
$('#plants-todo').click(function() {

  swal({  
        title: "Water Plants on Desk and on Shelf Above Desk",
        text: "From the Silver Watering Can, Fill Turkey Baster Once and Then Water Evenly Among the Plants on my Desk. Then, Each of the Three Plants on my Black Shelf Above my Desk Gets 1 Full Turkey Baster of Water as Well",
        icon: "info",
        buttons:{
            okay:{
                text: "Cancel",
